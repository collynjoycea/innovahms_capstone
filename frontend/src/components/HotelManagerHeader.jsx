...
import { Search, Bell, User, LogOut, Moon, Sun, ShieldCheck, ChevronDown, UserCircle } from 'lucide-react';
import ShiftClockWidget from './ShiftClockWidget';
import useStaffSession from '../hooks/useStaffSession';

const HotelManagerHeader = ({ isDarkMode, toggleTheme }) => {
  ...
  const theme = {
    bg:       isDarkMode ? 'bg-[#080808]/80' : 'bg-white/80',
...
export default HotelManagerHeader;
